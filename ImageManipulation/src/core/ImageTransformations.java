...
/**
 * Class that provides the ability to rotate a picture
 * 
 * @author Pommesfee
 * @version 1.0
 * @since 1.0
...
public class ImageTransformations {
	...
	/**
	 * Method to calculated the new coordinates of an point, which should be
	 * rotated.
	 * 
	 * @param x
	 *            The x-coordinate of the point which should be rotated
	 * @param y
	 *            The y-coordinate of the point which should be rotated
	 * @param angle
	 *            The angle by which the point should be rotated (in Degrees)
	...
	/**
	 * This Method rotates the picture by calculating new coordinates for the
	 * points from a given picture using a given angle.
	 * 
	 * @param pic
	 *            Picture which should be rotated
	 * @param angle
	 *            The angle by which the picture should be rotated
	...
	public static Picture rotatePic(Picture pic, double angle) {
		...
		// Extrem Punkte des Bildes bestimmen(Punkte an denen das Bild die
		// maximale Ausdehnung hat)
		...
		// Das rotierete Bild erzeugen/Einen Punkt erzeugen(au�erhalb der
		// for-Schleife um speicher verbrauch zu minimieren)
		Picture rotatedPicture = new Picture(width, height);
		Point p = new Point();

		// �ber Bildpunkte des zugrundeliegenden Bildes laufen und neue Werte
		// bestimmen
